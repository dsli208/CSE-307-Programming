...
_lr_productions = [
  ...
  ('statement -> expression','statement',1,'p_statement_expr','calcparser.py',31),
  ('expression -> expression PLUS expression','expression',3,'p_expression_binop','calcparser.py',36),
  ('expression -> expression MINUS expression','expression',3,'p_expression_binop','calcparser.py',37),
  ('expression -> expression TIMES expression','expression',3,'p_expression_binop','calcparser.py',38),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_binop','calcparser.py',39),
  ('expression -> MINUS expression','expression',2,'p_expression_uminus','calcparser.py',43),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_group','calcparser.py',47),
  ('expression -> NUMBER','expression',1,'p_expression_number','calcparser.py',51),
  ('expression -> NAME','expression',1,'p_expression_name','calcparser.py',55),
]
