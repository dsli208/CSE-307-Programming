...
_lr_productions = [
  ...
  ('statement -> NAME EQUALS expression','statement',3,'p_statement_assign','calcparser.py',27),
  ('statement -> expression','statement',1,'p_statement_expr','calcparser.py',32),
  ('expression -> expression PLUS expression','expression',3,'p_expression_binop','calcparser.py',37),
  ('expression -> expression MINUS expression','expression',3,'p_expression_binop','calcparser.py',38),
  ('expression -> expression TIMES expression','expression',3,'p_expression_binop','calcparser.py',39),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_binop','calcparser.py',40),
  ('expression -> MINUS expression','expression',2,'p_expression_uminus','calcparser.py',47),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_group','calcparser.py',51),
  ('expression -> NUMBER','expression',1,'p_expression_number','calcparser.py',55),
  ('expression -> NAME','expression',1,'p_expression_name','calcparser.py',59),
]
